...
async function checkEvents() {
  ...
  if (startClicks?.length > 0) console.log('First start click:', JSON.stringify(startClicks[0], null, 2));
  ...
  if (abandonedEvents?.length > 0) console.log('First abandoned event:', JSON.stringify(abandonedEvents[0], null, 2));
