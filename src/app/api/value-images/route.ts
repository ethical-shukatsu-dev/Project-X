...
import {
  fetchAndSaveImagesForCategory as fetchAndSavePexelsImagesForCategory,
  fetchAndSaveImagesForAllCategories as fetchAndSavePexelsImagesForAllCategories,
} from '@/lib/pexels/client';
import {
  fetchAndSaveImagesForCategory as fetchAndSaveUnsplashImagesForCategory,
  fetchAndSaveImagesForAllCategories as fetchAndSaveUnsplashImagesForAllCategories,
  ...
  try {
    ...
    // Handle JSON requests for API fetching
      ...
      try {
        ...
        console.error(
          `Error fetching images from ${action === 'fetch_pexels' ? 'Pexels' : 'Unsplash'}:`,
          error
        );
