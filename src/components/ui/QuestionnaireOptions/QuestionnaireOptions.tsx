...
export default function QuestionnaireOptions({ lng, className = '' }: QuestionnaireOptionsProps) {
  ...
  const content = (
    <div className={`space-y-4 sm:space-y-6  ${className}`}>
      <Link href={`/${lng}/questionnaire?type=text`} onClick={() => handleSurveyStart('text')}>
        <StarBorder
          as="div"
          color="#3B82F6"
